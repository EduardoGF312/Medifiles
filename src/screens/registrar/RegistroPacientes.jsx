...
const RegistroPacientes = () => {
  ...
  const sendFormData = () => {
    ...
    try {
      const response = axios.post('https://integradora.fly.dev/pacientes', formData)
      ...
      console.error(error)
      alert('Error al guardar al paciente')
    }
  }
  ...
  return (
    <ScrollView style={[styles.container]}>
      <Text style={[styles.title, { color: theme.titleColor }]}>Nuevo Paciente</Text>
